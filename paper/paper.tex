...
\paragraph{Calibration.} On held-out reference works the verifier separates same-author from different-author cases almost perfectly: genuine Severian works score a mean BDI of $0.86$ against Severian, other authors $0.09$ (AUC $\approx 1.0$). Scores are therefore interpretable on an absolute scale, and they are stable: across five random seeds the standard deviation of a group's score is $0.00$--$0.04$.
